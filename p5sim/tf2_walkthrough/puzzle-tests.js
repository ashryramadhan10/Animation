(function runPuzzleTests(root) {
  ...
  test("algo catalog lists its sections in site order and validates", () => {
    withCatalog(algoApi(), () => {
      ...
      assert(status.valid, status.message);
      const api = puzzlesApi();
      same(api.TF2_PUZZLE_TRACKS.map((track) => track.id), ["intro", "sorting", "dp", "graphs", "range", "trees", "math", "strings", "geometry", "window", "bitwise", "construction", "advanced", "advanced-graphs", "counting", "additional-i", "additional-ii"]);
      ...
      same(idsOf("additional-i"), ["shortest-subsequence", "distinct-values-sum", "distinct-values-splits", "swap-game", "beautiful-permutation-ii", "multiplication-table", "bubble-sort-rounds-i", "bubble-sort-rounds-ii", "dominance-max", "nearest-campsites-i", "nearest-campsites-ii", "advertisement", "special-substrings", "counting-lcm-arrays", "square-subsets", "subarray-sum-constraints", "water-containers-moves", "water-containers-queries", "stack-weights", "maximum-average-subarrays", "subsets-with-fixed-average", "two-array-average", "pyramid-array", "permutation-subsequence", "bit-inversions", "writing-numbers", "letter-pair-move-game", "maximum-building-i", "sorting-methods", "cyclic-array", "list-of-sums"]);
      same(idsOf("additional-ii"), ["bouncing-ball-steps", "bouncing-ball-cycle", "knight-moves-queries", "k-subset-sums-i", "k-subset-sums-ii", "increasing-array-ii", "food-division", "swap-round-sorting", "binary-subsequences", "school-excursion", "coin-grid", "grid-coloring-ii", "programmers-and-artists", "removing-digits-ii", "coin-arrangement", "replace-with-difference", "grid-puzzle-i", "grid-puzzle-ii", "bit-substrings", "reversal-sorting", "book-shop-ii", "gcd-subsets", "minimum-cost-pairs", "same-sum-subsets", "mex-grid-queries", "maximum-building-ii", "stick-divisions", "stick-difference", "coding-company", "two-stacks-sorting"]);
      ...
      same(Array.from(unlocked), ["weird-algorithm", "distinct-numbers", "dice-combinations", "counting-rooms", "static-range-sum-queries", "subordinates", "josephus-queries", "word-combinations", "cross-sign", "generated-array", "counting-bits", "inverse-inversions", "subset-sums", "nearest-shops", "filled-subgrid-count-i", "shortest-subsequence", "bouncing-ball-steps"]);
    });
  });
