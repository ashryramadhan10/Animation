(function assembleAlgoPuzzles(root) {
  ...
  if (inNode) ["01-introductory", "02-sorting", "03-dp", "04-graphs", "05-range", "06-trees", "07-math", "07-math-ii", "08-strings", "09-geometry", "10-window", "11-bitwise", "12-construction"].forEach((name) => require("./algo/" + name + ".js"));
