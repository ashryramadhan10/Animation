...
| 4 | Graph Algorithms | 34 | union-find, topological order, SCC (Tarjan/Kosaraju), Euler tour, 2-SAT, max flow, bipartite matching |
| 5 | Range Queries | 22 | Fenwick tree, sparse table, lazy segment tree, persistent tree, offline sorting |
| 6 | Tree Algorithms | 16 | Euler tour + segment tree, centroid decomposition, small-to-large merging |
| 7 | Mathematics | 36 | modular BigInt arithmetic, sieve, factorials and inverses, matrix power, Gaussian elimination, Grundy |
